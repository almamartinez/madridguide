...
public class MadridGuideProviderTests extends AndroidTestCase {
    public void testQueryAllShops() {
        ...
        Cursor c = cr.query(MadridGuideProvider.SHOPS_URI, DBConstants.Shop.SHOP_ALL_COLUMNS, null, null, null);
        assertNotNull(c);
    }
    ...
    public void testInsertAShop() {
        ...
        final Cursor beforeCursor = cr.query(MadridGuideProvider.SHOPS_URI, DBConstants.Shop.SHOP_ALL_COLUMNS, null, null, null);
        final int beforeCount = beforeCursor.getCount();

        final Shop shop = new Shop(1, "Little shop of horrors!");
        final Uri insertedUri = cr.insert(MadridGuideProvider.SHOPS_URI, new ShopDAO(getContext()).getContentValues(shop));
        assertNotNull(insertedUri);

        final Cursor afterCursor = cr.query(MadridGuideProvider.SHOPS_URI, DBConstants.Shop.SHOP_ALL_COLUMNS, null, null, null);
