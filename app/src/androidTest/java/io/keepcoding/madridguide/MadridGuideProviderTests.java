...
public class MadridGuideProviderTests extends AndroidTestCase {
    public void testQueryAllShops() {
        ...
        Cursor c = cr.query(MadridGuideProvider.SHOPS_URI, DBConstants.SHOP_ALL_COLUMNS, null, null, null);
        assertNotNull(c);
    }
    ...
    public void testInsertAShop() {
        ...
        final Cursor beforeCursor = cr.query(MadridGuideProvider.SHOPS_URI, DBConstants.SHOP_ALL_COLUMNS, null, null, null);
        ...
        final Cursor afterCursor = cr.query(MadridGuideProvider.SHOPS_URI, DBConstants.SHOP_ALL_COLUMNS, null, null, null);
